  ...
  const handleSubmitItem = async (e) => {
    ...
    if (image) {
      ...
      const { data, error } = await supabase.storage
        .from('item_pics') // Use the correct storage bucket name
        .upload(`items/${image.name}`, image)
      ...
      const imageUrl = `https://nsnoztviefjxvptztmnj.supabase.co/storage/v1/object/public/item_pics/items/${image.name}`
  
      // Insert the item into the "items" table with the image URL
        ...
        .insert([
          {
            ...
            item_image_url: imageUrl, // Include the image URL
          },
        ]);
              ...
              <div className="py-2">
                <div>
                  ...
                  >
                    ...
                    <div className="flex flex-col text-center">
                      <label className="text-lg font-semibold" htmlFor="itemImage">
                        Item Image
                      </label>
                      <input
                        type="file"
